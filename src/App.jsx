...
function AppContent() {
    ...
    const handleUpdate = async () => {
        console.log('[APP] Botón ACTUALIZAR presionado. Iniciando procedimiento nuclear v21...');
    ...
    useEffect(() => {
        const registerServiceWorker = async () => {
            ...
            if ('serviceWorker' in navigator && !import.meta.env.DEV) {
                try {
                    console.log('[APP] Registrando Service Worker v21...');
                    ...
                    registration.addEventListener('updatefound', (event) => {
                        ...
                        console.log('[APP] Nueva versión de SW encontrada (v21).');
    ...
    return (
        <>
            {/* --- ALERTA DE ACTUALIZACIÓN DE PWA (FINAL V21) --- */}
            <Snackbar 
