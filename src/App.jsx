...
function AppContent() {
    ...
    const handleUpdate = async () => {
        console.log('[APP] Botón ACTUALIZAR presionado. Iniciando procedimiento nuclear v19...');
    ...
    useEffect(() => {
        const registerServiceWorker = async () => {
            ...
            if ('serviceWorker' in navigator && !import.meta.env.DEV) {
                try {
                    console.log('[APP] Registrando Service Worker v19...');
                    ...
                    registration.addEventListener('updatefound', (event) => {
                        ...
                        console.log('[APP] Nueva versión de SW encontrada (v19).');
    ...
    return (
        <>
            {/* --- ALERTA DE ACTUALIZACIÓN DE PWA (FINAL v19) --- */}
            <Snackbar 
