...
function AppContent() {
    ...
    const handleUpdate = async () => {
        console.log('[APP] Botón ACTUALIZAR presionado. Iniciando procedimiento nuclear v20...');
    ...
    useEffect(() => {
        const registerServiceWorker = async () => {
            ...
            if ('serviceWorker' in navigator && !import.meta.env.DEV) {
                try {
                    console.log('[APP] Registrando Service Worker v20...');
                    ...
                    registration.addEventListener('updatefound', (event) => {
                        ...
                        console.log('[APP] Nueva versión de SW encontrada (v20).');
    ...
    return (
        <>
            {/* --- ALERTA DE ACTUALIZACIÓN DE PWA (FINAL v20) --- */}
            <Snackbar 
